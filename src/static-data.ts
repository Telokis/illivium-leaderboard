...
export const dungeons: Array<DungeonSpec> = [
  ...
  { fullName: "Brackenhide Hollow", shortName: "BH", referenceTime: 36 * 60 },
  { fullName: "Halls of Infusion", shortName: "HOI", referenceTime: 38 * 60 },
  { fullName: "Neltharus", shortName: "NELT", referenceTime: 35 * 60 },
  { fullName: "Nokhud Offensive", shortName: "NO", referenceTime: 40 * 60 },
  { fullName: "Ruby Life Pools", shortName: "RLP", referenceTime: 30 * 60 },
  { fullName: "The Azure Vault", shortName: "AV", referenceTime: 35 * 60 },
  {
