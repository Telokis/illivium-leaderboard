...
export const dungeons: Array<DungeonSpec> = [
  ...
  { fullName: "DOTI: Galakrond's Fall", shortName: "FALL", referenceTime: 34 * 60 },
  { fullName: "DOTI: Murozond's Rise", shortName: "RISE", referenceTime: 35 * 60 },
  { fullName: "Darkheart Thicket", shortName: "DHT", referenceTime: 30 * 60 },
  { fullName: "The Everbloom", shortName: "EB", referenceTime: 33 * 60 },
  { fullName: "Throne of the Tides", shortName: "TOTT", referenceTime: 34 * 60 },
  { fullName: "Waycrest Manor", shortName: "WM", referenceTime: 36 * 60 + 40 },
];
